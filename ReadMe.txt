This is a program that performs various image processing algorithms written from scratch.
STEPS:
...
NOTE: The parameter button is only used for the hough operation. Enter the number of desired lines you want to draw in the 'some param' dialog.